        ...
        <div className="rounded-[32px] border border-slate-200 bg-white/80 p-8 shadow-xl backdrop-blur-xl md:p-10">
          ...
          {step === "success" && (
            <div className="text-center">
              ...
              <p className="mt-4 text-slate-600">
                We've received your details and will send your
                booking link shortly.
              </p>

              <div className="mt-8 rounded-2xl border border-green-200 bg-green-50 p-4 text-green-700">
                Check your inbox within the next 24 hours.
              </div>
            </div>
          )}
        </div>
